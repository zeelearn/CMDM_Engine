<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Manage_Batch.aspx.cs" Inherits="Manage_Batch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" Runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">
                    Batch<span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
        ...
        <div class="row-fluid">
                                        ...
                                        <table cellpadding="3" class="table table-striped table-bordered table-condensed">
                                            <tr>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none; width: 138%;" 
                                                        class="table-hover">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox runat="server" ID="txtBatchName" ToolTip="Batch Name" type="text" Width="205px" MaxLength="50" />
                                            ...
                                            <tr>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none; width: 137%;" 
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:ListBox runat="server" ID="ddlCentre" Width="215px" ToolTip="Test Mode" data-placeholder="Select Centre"
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper">
                ...
                <asp:DataList ID="dlGridDisplay"  CssClass="table table-striped table-bordered table-hover"
                    ...
                    <ItemTemplate>
                    <asp:Label ID="Label25" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Batch_Code")%>' />
                    </td>
                    <td>
                        ...
                        <td>
                            <asp:Label ID="Label27" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Subjects")%>' />
                        </td>
                ...
                <asp:DataList ID="dlGridExport" Visible="false" runat="server" ItemStyle-BackColor="Silver"
                    ...
                    runat="server" Width="100%" OnSelectedIndexChanged="dlGridExport_SelectedIndexChanged">
                    <HeaderTemplate>
                    <b>Batch Code</b>
                    </th>
                    <th>
                    ...
                    <td>
                        ...
                        <td>
                            <asp:Label ID="Label28" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Subjects")%>' />
                        </td>
                    </ItemTemplate>
                </asp:DataList>
            </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:DropDownList runat="server" ID="ddlDivision_Add" ToolTip="Division" data-placeholder="Select Division"
                                                                CssClass="chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlDivision_Add_SelectedIndexChanged" Width="235px"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:DropDownList runat="server" ID="ddlAcadYear_Add" ToolTip="Academic Year" data-placeholder="Select Acad Year" OnSelectedIndexChanged="ddlAcadYear_SelectedIndexChanged"
                                                                CssClass="chzn-select" Width="235px"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:DropDownList runat="server" ID="ddlStandard_Add" ToolTip="Standard" data-placeholder="Select Standard"
                                                                CssClass="chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlStandard_Add_SelectedIndexChanged" Width="235px"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td class="span6" style="text-align: left">
                                                <table cellpadding="0" class="table-hover" style="border-style: none;" width="100%">
                                                    <tr>
                                                        <td class="span2" style="border-style: none; text-align: left;">
                                                            <asp:Label ID="Label29" runat="server" CssClass="red">LMS Product</asp:Label>
                                                        </td>
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:DropDownList ID="ddllmsproduct" runat="server" AutoPostBack="True" CssClass="chzn-select" 
                                                                data-placeholder="Select LMS Product" OnSelectedIndexChanged="ddllmsproduct_SelectedIndexChanged" 
                                                                ToolTip="LMS Product" Width="235px"  />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="span6" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                    <tr>
                                                        <td class="span2" style="border-style: none; text-align: left;">
                                                            <asp:Label runat="server" ID="Label6" CssClass="red">Classroom Product(s)</asp:Label>&nbsp;<span class="help-button ace-popover"
                                                        ...
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:ListBox runat="server" ID="ddlProduct_Add" ToolTip="Product(s)" SelectionMode="Multiple"
                                                                data-placeholder="Select Product(s)" CssClass="chzn-select" AutoPostBack="True" class="span12" OnSelectedIndexChanged="ddlProduct_Add_SelectedIndexChanged" Width="235px"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td class="span6" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none; height: 28px;" class="table-hover" width="100%">
                                                    <tr>
                                                        <td class="span2" style="border-style: none; text-align: left;">
                                                            <asp:Label runat="server" ID="Label7" CssClass="red">Subject(s)</asp:Label>&nbsp;<span class="help-button ace-popover"
                                                        ...
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:ListBox runat="server" ID="ddlSubject_Add" ToolTip="Subject(s)" SelectionMode="Multiple"
                                                                data-placeholder="Select Subject(s)" CssClass="chzn-select" AutoPostBack="True" class="span12" 
                                                               OnSelectedIndexChanged="ddlSubject_Add_SelectedIndexChanged" Width="235px"  style=""/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:ListBox runat="server" ID="ddlCentre_Add" ToolTip="Select Centre(s)" SelectionMode="Multiple"
                                                                data-placeholder="Select Centre(s)" CssClass="chzn-select" AutoPostBack="True" Width="235px" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td class="span6" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                    <tr>
                                                        <td class="span2" style="border-style: none; text-align: left;">
                                                            <asp:Label runat="server" ID="Label2" CssClass="red">Max Batch Strength</asp:Label>&nbsp;<span class="help-button ace-popover"
                                                        ...
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            ...
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ValidationGroup="UcValidate"
                                                                ControlToValidate="txtBatchStrength_Add" ErrorMessage="Batch Strength can't be blank !!">*</asp:RequiredFieldValidator>
                                        ...
                                        <tr>
                                            <td class="span6" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                    <tr>
                                                        <td class="span2" style="border-style: none; text-align: left;">
                                                            <asp:Label runat="server" ID="Label19" CssClass="red">Product(s)</asp:Label>&nbsp;<span class="help-button ace-popover"
                                                                data-trigger="hover" data-placement="right" data-content="Students who have taken admission for these Product(s) will be available for the new Academic Batch(es)"
                                                                title="Product(s)">?</span>
                                                        </td>
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:ListBox runat="server" ID="ddlProduct_Edit" ToolTip="Product(s)" SelectionMode="Multiple"
                                                                data-placeholder="Select Product(s)" CssClass="chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlProduct_Edit_SelectedIndexChanged" Width="215px"/>
                                            ...
                                            <td class="span6" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                    <tr>
                                                        <td class="span2" style="border-style: none; text-align: left;">
                                                            <asp:Label runat="server" ID="Label20" CssClass="red">Subject(s)</asp:Label>&nbsp;<span class="help-button ace-popover"
                                                                data-trigger="hover" data-placement="right" data-content="Subject(s) selected will be available for Academic activity"
                                                                title="Subject(s)">?</span>
                                                        </td>
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:ListBox runat="server" ID="ddlSubject_Edit" ToolTip="Subject(s)" SelectionMode="Multiple"
                                                                data-placeholder="Select Subject(s)" CssClass="chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlSubject_Edit_SelectedIndexChanged" Width="215px"/>
                                        ...
                                        <tr>
                                            <td class="span6" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                    <tr>
                                                        <td class="span2" style="border-style: none; text-align: left;">
                                                            <asp:Label runat="server" ID="Label22" CssClass="red">Max Batch Strength</asp:Label>&nbsp;<span class="help-button ace-popover"
                                                                data-trigger="hover" data-placement="right" data-content="Maximum number of students that are allowed in the Batch"
                                                                title="Max Batch Strength">?</span>
                                                        </td>
                                                        <td class="span4" style="border-style: none; text-align: left;">
