<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeFile="Config_Board.aspx.cs" Inherits="Config_Board" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">
                    Manage Board<span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                                    ...
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 28%;">
                                                                <asp:Label runat="server" ID="Label2">Board Name</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 100%;">
                                                                <asp:TextBox ID="txtSearchboardname" runat="server" Width="205px" onkeypress="return CharacterOnly(event);"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
            ...
            <div id="DivResultPanel" runat="server" visible="false">
                ...
                <div class="widget-box">
                    ...
                    <asp:DataList ID="ddlBoard" CssClass="table table-striped table-bordered table-hover"
                        ...
                        <td>
                            <asp:Label ID="lblBoardCode"  runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Long_Description")%>' />
                            </td>
                            <td style="width: 30%; text-align: left">
                                <asp:Label ID="lblBoardNo" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Short_Description")%>' />
                            </td>
                            ...
                            <td style="width: 10%; text-align: center">                                
                                            <asp:LinkButton ID="lblEdit" runat="server" class="btn-small btn-primary icon-info-sign" data-rel="tooltip"
                                                CommandName='comEdit' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"id")%>'
                    ...
                    <asp:DataList ID="DataList1" CssClass="table table-striped table-bordered table-hover"
                        runat="server" Width="100%" OnItemCommand="dllecture_ItemCommand" Visible ="false">
                        <HeaderTemplate>
                        <b>Board Code</b>
                        </th>
                            <th>
                                            ...
                                            <tr>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label runat="server" ID="Label7" CssClass="red">Board Name</asp:Label>
                                                                
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox ID="txtboardname" runat="server" Width="205px" onkeypress="return CharacterOnly(event);"></asp:TextBox>
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label runat="server" ID="Label8" CssClass="red">Board Display Name</asp:Label>
                                                                                                                              
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox ID="txtboarddisplayname" runat="server" Width="205px" onkeypress="return CharacterOnly(event);"></asp:TextBox>                                                                
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            ...
                                            <tr>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label runat="server" ID="Label12" CssClass="red">Board Short Name</asp:Label>
                                                                
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox ID="txtboardshortname" runat="server" Width="205px"></asp:TextBox>
                                                    ...
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;" colspan="2">
                                                                <asp:Label runat="server" ID="Label13" CssClass="red">Board Description</asp:Label>
                                                                
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox ID="txtboarddescription" runat="server" Width="205px"></asp:TextBox>
                                            ...
                                            <tr>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label runat="server" ID="Label1">Board Sequence No</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox ID="txtboardsequenceno" runat="server" Width="205px"  onkeypress="return IsNumeric(event);" ondrop="return false;" onpaste="return false;" ></asp:TextBox>
