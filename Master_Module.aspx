<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Master_Module.aspx.cs" Inherits="Master_Module" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="Server">
    <script type="text/javascript">
        ...
        function NumberandCharOnly() {
            var AsciiValue = event.keyCode
            if ((AsciiValue >= 65 && AsciiValue <= 90) || (AsciiValue >= 97 && AsciiValue <= 122) || (AsciiValue >= 48 && AsciiValue <= 57) || AsciiValue == 45 || AsciiValue == 95)
                event.returnValue = true;
            else
                event.returnValue = false;
        }
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">
                    Module<span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
        ...
        <div class="row-fluid">
                                            ...
                                            <tr>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" class="table-hover" style="border-style: none;" 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList ID="ddlChapter" runat="server" AutoPostBack="True" 
                                                                    CssClass="chzn-select" data-placeholder="Select Chapter" ToolTip="Chapter" 
                                                                    Width="215px" onselectedindexchanged="ddlChapter_SelectedIndexChanged" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" class="table-hover" style="border-style: none;" 
                                                        ...
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label6" runat="server" >Topic</asp:Label>                                                                
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList ID="ddlTopic" runat="server" AutoPostBack="True" 
                                                                    ...
                                                                    Width="215px" onselectedindexchanged="ddlTopic_SelectedIndexChanged" />
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" class="table-hover" style="border-style: none;" 
                                                        ...
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label ID="Label9" runat="server" >SubTopic</asp:Label>                                                                
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:DropDownList ID="ddlSubTopic" runat="server" AutoPostBack="True" 
                                                                    CssClass="chzn-select" data-placeholder="Select SubTopic" ToolTip="SubTopic" 
                                                                    Width="215px" />
                                                            </td>
                                                        </tr>
                                                    </table>
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper">
                    ...
                    <tr>
                        ...
                        <td class="span4" style="text-align: left">
                            <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                <tr>
                                    <td style="border-style: none; text-align: left; width: 40%;">
                                        <asp:Label runat="server" ID="Label12">SubTopic</asp:Label>                                        
                                    </td>
                                    <td style="border-style: none; text-align: left; width: 60%;">
                                        <asp:Label runat="server" ID="lblSubTopic_Result" class="blue"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                            ...
                            <ItemTemplate>
                            <asp:Label runat="server" ID="Label8" Visible="true" Text='<%#DataBinder.Eval(Container.DataItem,"Module_Code")%>'></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtDLTopicName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Module_Name")%>'
                                ...
                                <asp:Label ID="lblDLTopicName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Module_Name")%>'
                                    Visible='<%#(int)DataBinder.Eval(Container.DataItem,"ShowEditButtonFlag") == 1 ? true : false%>' />
                                </td>
                                <td>
                                    <asp:TextBox ID="txtDLDisplayName" runat="server" MaxLength ="80" Text='<%#DataBinder.Eval(Container.DataItem,"Module_DisplayName")%>'
                                        Visible='<%#(int)DataBinder.Eval(Container.DataItem,"ShowSaveButtonFlag") == 1 ? true : false%>' Width="85%" Enabled ='<%#(int)DataBinder.Eval(Container.DataItem,"AllowModuleNameEditFlag") == 1 ? true : false%>'  />
                                    <asp:Label ID="lblDLDisplayName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Module_DisplayName")%>'
                                        Visible='<%#(int)DataBinder.Eval(Container.DataItem,"ShowEditButtonFlag") == 1 ? true : false%>' />
                                    <asp:Label runat="server" ID="lblDLTopic_Code" Visible="false" Text='<%#DataBinder.Eval(Container.DataItem,"Module_Code")%>'></asp:Label>
                                </td>
                                <td style="width: 15%; text-align: left;">
                                    <asp:TextBox ID="txtDLTopic_Description" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Module_Description")%>'
                                        Visible='<%#(int)DataBinder.Eval(Container.DataItem,"ShowSaveButtonFlag") == 1 ? true : false%>' Width="85%" />
                                    <asp:Label ID="lblDLTopic_Description" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Module_Description")%>'
                                        Visible='<%#(int)DataBinder.Eval(Container.DataItem,"ShowEditButtonFlag") == 1 ? true : false%>' />
                                </td>
                                <td style="width: 8%; text-align: center;">
                                    <asp:TextBox ID="txtDLTopic_SequenceNo" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Module_SequenceNo")%>'
                                        Visible='<%#(int)DataBinder.Eval(Container.DataItem,"ShowSaveButtonFlag") == 1 ? true : false%>' Width="85%"  MaxLength="5" onkeypress="return NumberOnly()" />
                                    <asp:Label ID="lblDLTopic_SequenceNo" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Module_SequenceNo")%>'
                                        Visible='<%#(int)DataBinder.Eval(Container.DataItem,"ShowEditButtonFlag") == 1 ? true : false%>' />
                                </td>
                                ...
                                <td style="text-align: center;">
                                    <asp:LinkButton ID="lnkDLEdit" ToolTip="Edit" class="btn-small btn-primary icon-info-sign"
                                        CommandArgument='<%#DataBinder.Eval(Container.DataItem,"Module_Code")%>' runat="server"
                                    ...
                                    <asp:LinkButton ID="lnkDLSave" ToolTip="Save" class="btn-small btn-success icon-save"
                                        runat="server" CommandName="Save" Height="25px" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"Module_Code")%>'
                ...
                <asp:DataList ID="dlGridExport" Visible="false" runat="server" ItemStyle-BackColor="Silver"
                    ...
                    <ItemTemplate>
                    <asp:Label runat="server" ID="Label823" Visible="true" Text='<%#DataBinder.Eval(Container.DataItem,"Module_Code")%>'></asp:Label>
                    </td>
                    <td>
                            <asp:Label ID="lblTopic" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Module_Name")%>' />
                        </td>
                        <td>
                            <asp:Label ID="lblDisplayName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Module_DisplayName")%>' />
                        </td>
                        <td>
                            <asp:Label ID="lblDescription" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Module_Description")%>' />
                        </td>
                        <td>
                            <asp:Label ID="lblSeqNo" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Module_SequenceNo")%>' />
                        </td>
                        <td>
