...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">Teacher Teaching Details<span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                            ...
                            <div class="widget-main">
                                ...
                                <table cellpadding="3" class="table table-striped table-bordered table-condensed">
                                    ...
                                    <tr>
                                        ...
                                        <td class="span4" style="text-align: left">
                                           ...
                                           <td class="span4" style="text-align: left">
                                            <asp:Button class="btn btn-app btn-primary  btn-mini radius-4" runat="server" Visible="false" ID="btnCopyfaculty"
                                                Text="Copy" ToolTip="Copy teachers for all chapters" onclick="btnCopyfaculty_Click" />
                                        </td>
                                    </tr>
                                </table>
                                <asp:UpdatePanel ID="updatepanneladd" runat="server" UpdateMode="Conditional">
                                    <ContentTemplate>
                                        ...
                                        <th><b>Chapter Short Name</b> </th>
                                                <th align="left" style="width: 30%">Chapter Name
                                                </th>
                                                <th style="width: 15%; text-align: center;">No. of Lectures
                                                </th>
                                                <th style="width: 20%; text-align: left;">Teacher Short Name
                                                </th>
                                        ...
                                        <td>
                                            <asp:Label ID="lblDLChapterShortName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Chapter_ShortName")%>' />
                                                ...
                                                Width="85%" onkeypress="return NumberandCharOnly(event);" Visible="false" />--%>
