<%@ Page Title="" Language="C#" MasterPageFile="~/Main.Master" AutoEventWireup="true"
    CodeFile="Menu.aspx.cs" Inherits="Config_Course" %>
        ...
        <div class="row-fluid">
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper" visible="false">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <ItemTemplate>                            
                        ...
                        <td style="text-align: left;">
                            <asp:Label ID="Label2" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Display_Order_No")%>' />
                        </td>
                        <td style="text-align: left;">
                        ...
                        <td style="width: 9%; text-align: center;">
                            <div class="inline position-relative">                                                           
                                ...
                                <asp:LinkButton ID="lnkEdit" ToolTip="Edit" class="btn-small btn-primary icon-info-sign"
                                        ...
                                        &nbsp;
                                <asp:LinkButton ID="lnkUserMenu" ToolTip="Role" class="btn-small btn-primary icon-info-sign"
                                        CommandArgument='<%#DataBinder.Eval(Container.DataItem,"Menu_Code")%>' runat="server"
                                        CommandName="comUserMenu" Height="25px" />
            ...
            <div id="DivUserMenu" runat="server" visible="false">
                <div class="widget-box">
                    <div class="widget-header widget-header-small header-color-dark">
                        <h5 class="modal-title">
                            Edit Menu<asp:Label runat="server" ID="lblmenuPK" Visible="False"></asp:Label>
                        &nbsp;</h5>
                    </div>
                    <div class="widget-body">
                        <div class="widget-body-inner">
