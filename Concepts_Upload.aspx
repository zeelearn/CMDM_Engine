<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Concepts_Upload.aspx.cs" Inherits="Concepts_Upload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">Concepts Upload<span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
    ...
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
                        ...
                        <ContentTemplate>--%>
                            ...
                            <asp:DataList ID="datalist_NewUploads1" CssClass="table table-striped table-bordered table-hover"
                                ...
                                <HeaderTemplate>
                                    ...
                                    <th>Concept_Description
                                    </th>
                                    <th>Concept_Generic_Name
                                    </th>
                                    <th>Module_AV
                                    </th>
                                ...
                                <ItemTemplate>
                                    ...
                                    <td style="text-align: left;">
                                        <asp:Label ID="lblconceptsdescription" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Concept_Description")%>' />
                                    </td>
                                    <td style="text-align: left;">
                                        <asp:Label ID="lblconceptgenericname" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Concept_Generic_Name")%>' />
                                    </td>
                                    <td style="text-align: left;">
                                        <asp:Label ID="lblmoduleav" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Module_AV")%>' />
                                    </td>
            ...
            <div class="modal fade" id="downloadselection" style="left: 57% !important; top: 20% !important; width: auto; height: auto; display: none;"
