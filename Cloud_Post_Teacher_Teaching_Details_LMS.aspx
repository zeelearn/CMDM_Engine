<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Cloud_Post_Teacher_Teaching_Details_LMS.aspx.cs" Inherits="Cloud_Post_Teacher_Teaching_Details_LMS" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">Post Teacher Teaching Details LMS<span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                            ...
                                            <tr>
                                                ...
                                                <td class="span4" style="text-align: left">
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label runat="server" ID="lblcenter" CssClass="red">Center </asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
    ...
    <div id="DivResultPanel" runat="server" class="dataTables_wrapper">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <HeaderTemplate>
                        <b>Partner Code</b> </th>
                        <th align="left" style="width: 25%; text-align: left;">Center Code
                        </th>
                        <th align="left" style="width: 25%; text-align: left;">Product Code
                        </th>
                        <th align="left" style="width: 25%; text-align: left;">Subject Code
                    ...
                    <ItemTemplate>
                        ...
                        <td style="text-align: left">
                            <asp:Label ID="lblLMSProductCode" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"LMSProductCode")%>' />
                        </td>
                        <td style="text-align: left">
