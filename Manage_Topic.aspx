<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Manage_Topic.aspx.cs" Inherits="Manage_Topic" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">
                    Topic<span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
        ...
        <div class="row-fluid">
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper">
                ...
                <table cellpadding="3" class="table table-striped table-bordered table-condensed">
                    ...
                    <tr>
                        ...
                        <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                            ...
                            <ItemTemplate>
                            <asp:Label runat="server" ID="Label6" Visible="true" Text='<%#DataBinder.Eval(Container.DataItem,"Topic_Code")%>'></asp:Label>
                            </td>
                            <td>
                                <asp:TextBox ID="txtDLTopicName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Topic_Name")%>'
                                ...
                                <asp:Label ID="lblDLTopicName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Topic_Name")%>'
                                    Visible='<%#(int)DataBinder.Eval(Container.DataItem,"ShowEditButtonFlag") == 1 ? true : false%>' />
                                </td>
                                <td>
                                    <asp:TextBox ID="txtDLDisplayName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Topic_DisplayName")%>'
                                        Visible='<%#(int)DataBinder.Eval(Container.DataItem,"ShowSaveButtonFlag") == 1 ? true : false%>' Width="85%" Enabled ='<%#(int)DataBinder.Eval(Container.DataItem,"AllowTopicNameEditFlag") == 1 ? true : false%>'  />
                                    <asp:Label ID="lblDLDisplayName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Topic_DisplayName")%>'
                                        Visible='<%#(int)DataBinder.Eval(Container.DataItem,"ShowEditButtonFlag") == 1 ? true : false%>' />
                                    <asp:Label runat="server" ID="lblDLTopic_Code" Visible="false" Text='<%#DataBinder.Eval(Container.DataItem,"Topic_Code")%>'></asp:Label>
                                </td>
                                <td style="width: 15%; text-align: left;">
                                    <asp:TextBox ID="txtDLTopic_Description" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Topic_Description")%>'
                                        Visible='<%#(int)DataBinder.Eval(Container.DataItem,"ShowSaveButtonFlag") == 1 ? true : false%>' Width="85%" />
                                    <asp:Label ID="lblDLTopic_Description" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Topic_Description")%>'
                                        Visible='<%#(int)DataBinder.Eval(Container.DataItem,"ShowEditButtonFlag") == 1 ? true : false%>' />
                                </td>
                                <td style="width: 15%; text-align: center;">
                                    <asp:TextBox ID="txtDLTopic_SequenceNo" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Topic_SequenceNo")%>'
                                    ...
                                    <asp:Label ID="lblDLTopic_SequenceNo" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Topic_SequenceNo")%>'
                                        Visible='<%#(int)DataBinder.Eval(Container.DataItem,"ShowEditButtonFlag") == 1 ? true : false%>' />
                                </td>
                                ...
                                <td style="text-align: center;">
                                    <asp:LinkButton ID="lnkDLEdit" ToolTip="Edit" class="btn-small btn-primary icon-info-sign"
                                        CommandArgument='<%#DataBinder.Eval(Container.DataItem,"Topic_Code")%>' runat="server"
                                    ...
                                    <asp:LinkButton ID="lnkDLSave" ToolTip="Save" class="btn-small btn-success icon-save"
                                        runat="server" CommandName="Save" Height="25px" CommandArgument='<%#DataBinder.Eval(Container.DataItem,"Topic_Code")%>'
                ...
                <asp:DataList ID="DataList1" CssClass="table table-striped table-bordered table-hover"
                            ...
                            <ItemTemplate>
                            <asp:Label runat="server" ID="Label643" Visible="true" Text='<%#DataBinder.Eval(Container.DataItem,"Topic_Code")%>'></asp:Label>
                            </td>
                                <td>
                                <asp:Label ID="lblDLTopicName" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"Topic_Name")%>'/>
                                </td>
                                <td>
                                    ...
                                    <asp:Label runat="server" ID="lblDLTopic_Code" Text='<%#DataBinder.Eval(Container.DataItem,"Topic_DisplayName")%>'></asp:Label>
                                </td>
                                <td style="width: 15%; text-align: left;">
