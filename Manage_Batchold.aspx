<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Manage_Batchold.aspx.cs" Inherits="Manage_Batchold" %>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:DropDownList runat="server" ID="ddlDivision_Add" ToolTip="Division" data-placeholder="Select Division"
                                                                CssClass="chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlDivision_Add_SelectedIndexChanged"  Width="215px"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td class="span6" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                    <tr>
                                                        ...
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:DropDownList runat="server" ID="ddlAcadYear_Add"  Width="215px" ToolTip="Academic Year" data-placeholder="Select Acad Year" OnSelectedIndexChanged="ddlAcadYear_SelectedIndexChanged"
                                            ...
                                            <td class="span6" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                    <tr>
                                                        ...
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:DropDownList runat="server" ID="ddlStandard_Add" Width="215px" ToolTip="Course" data-placeholder="Select Course"
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:ListBox runat="server" ID="ddlProduct_Add" ToolTip="Product(s)" SelectionMode="Multiple"
                                                                data-placeholder="Select Product(s)"  Width="215px" CssClass="chzn-select" AutoPostBack="True" class="span12" OnSelectedIndexChanged="ddlProduct_Add_SelectedIndexChanged"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td class="span6" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                    <tr>
                                                        ...
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:ListBox runat="server" ID="ddlSubject_Add" ToolTip="Subject(s)" SelectionMode="Multiple" Width="215px"
                                                                data-placeholder="Select Subject(s)" CssClass="chzn-select" AutoPostBack="True" class="span12" OnSelectedIndexChanged="ddlSubject_Add_SelectedIndexChanged"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:ListBox runat="server" ID="ddlCentre_Add" ToolTip="Select Centre(s)" SelectionMode="Multiple"
                                                                data-placeholder="Select Centre(s)" CssClass="chzn-select" AutoPostBack="True" Width="215px"/>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                        ...
                                        <tr>
                                            <td class="span6" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                    <tr>
                                                        <td class="span2" style="border-style: none; text-align: left;">
                                                            <asp:Label runat="server" ID="Label29"  CssClass="red" >LMS Product</asp:Label>
                                                        </td>
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="span4" style="border-style: none; text-align: left;">
                                                            <asp:ListBox runat="server" ID="ddlSubject_Edit" ToolTip="Subject(s)" SelectionMode="Multiple"
                                                                data-placeholder="Select Subject(s)" CssClass="chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlSubject_Edit_SelectedIndexChanged" />
