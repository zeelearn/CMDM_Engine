<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Config_Department.aspx.cs" Inherits="Config_Department" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">Departments<span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
        ...
        <div class="row-fluid">
                                                    ...
                                                    <table cellpadding="0" style="border-style: none; width: 138%;" class="table-hover">
                                                        ...
                                                        <tr>
                                                            <td style="border-style: none; text-align: left; width: 40%;">
                                                                <asp:Label runat="server" ID="Label12">Department Name</asp:Label>
                                                            </td>
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox runat="server" ID="txtdepartmentname" ToolTip="Department Name" Width="205px" />
                                                    </table>
                                                </td>
            ...
            <div id="DivResultPanel" runat="server" class="dataTables_wrapper" visible="false">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <HeaderTemplate>
                        <b>Deparment Name </b></th>
                <th>Department Long Desc
                </th>
                    ...
                    <ItemTemplate>
                        <asp:Label ID="Label25" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"DeptName")%>' />
                        </td>
                <td>
                    <asp:Label ID="lblCentre" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"DeptLongDesc")%>' />
                </td>
                        ...
                        <td style="text-align: center">
                            <asp:LinkButton ID="lblEdit" runat="server" class="btn-small btn-primary icon-info-sign"
                                data-rel="tooltip" CommandName='comEdit' CommandArgument='<%#DataBinder.Eval(Container.DataItem,"DeptID")%>'
                ...
                <asp:DataList ID="dlGridExport" Visible="false" runat="server" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <HeaderTemplate>
                        <b>Department Name</b> </th>
                <th>Deptarment Long Desc
                </th>
                        <th>Status
                        </th>
                ...
                <td>
                    <asp:Label ID="lblCentre1" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"DeptLongDesc")%>' />
                </td>
                        <td>
                            <asp:Label CssClass='<%# Convert.ToInt32( Eval("is_active")) == 1 ? "label label-success":"label label-warning"  %>'
                                runat="server" ID="linkActive">                                
                                        ...
                                        <tr runat="server" id="row1">
                                            <td class="span4" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                    <tr>
                                                        <td style="border-style: none; text-align: left; width: 40%;">
                                                            <asp:Label runat="server" ID="lbldeptname" CssClass="red">Department Name </asp:Label>
                                                        </td>
                                                        <td style="border-style: none; text-align: left; width: 60%;">
                                                            <asp:TextBox runat="server" ID="txtaddeditdepartmentname" ToolTip="Department Name" Width="205px" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td class="span4" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                    <tr>
                                                        <td style="border-style: none; text-align: left; width: 40%;">
                                                            <asp:Label runat="server" ID="lbldepltlongdesc" CssClass="red">Depatment Long Desc</asp:Label>
                                                        </td>
                                                        <td style="border-style: none; text-align: left; width: 60%;">
                                                            <asp:TextBox runat="server" ID="txtaddeditdepartmentlongdesc" ToolTip="Department Long Desc" Width="205px" />
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
