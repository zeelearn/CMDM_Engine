<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="Config_Country.aspx.cs" Inherits="Config_Country" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">
                    Country <span class="divider"></span>
                </h4>
            </li>
        </ul>
        <div id="nav-search">
    ...
    <div id="page-content" class="clearfix">
        ...
        <div class="row-fluid">
                                                    ...
                                                    <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                        <tr>
                                                            ...
                                                            <td style="border-style: none; text-align: left; width: 60%;">
                                                                <asp:TextBox runat="server" ID="txtsearchcountry" MaxLength="50" onkeypress="return CharacterOnlyspace(event);"></asp:TextBox>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </td>
            ...
            <div id="DivResultPanel" runat="server" >
                <div class="widget-box">
                ...
                <asp:DataList ID="dlGridDisplay" CssClass="table table-striped table-bordered table-hover"
                    ...
                    <ItemTemplate>
                        <asp:Label ID="lblID" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"country_code")%>' />
                        </td>
                        <td>
                            <asp:Label ID="Label6" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"country_name")%>' />
                        </td>
                        ...
                        <td style="width: 80px; text-align: center;">
                            <asp:LinkButton ID="lnkEditInfo" ToolTip="Edit" class="btn-small btn-primary icon-info-sign"
                                CommandArgument='<%#DataBinder.Eval(Container.DataItem,"country_code")%>' runat="server"
                                CommandName="Edit" />
                    </ItemTemplate>
                </asp:DataList>
                <asp:DataList ID="dlGridExport" Visible="false" ItemStyle-BackColor="Silver" BorderColor="Black" HorizontalAlign="Left"
                    CssClass="table table-striped table-bordered table-hover" runat="server" Width="100%" OnItemCommand="dlGridExport_ItemCommand">
                    <HeaderTemplate>
                        <b>Country Code</b> </th>
                        <th align="left">
                            Country Name
                    ...
                    <ItemTemplate>
                        ...
                        <td>
                            <asp:Label ID="Label21" runat="server" Text='<%#DataBinder.Eval(Container.DataItem,"country_name")%>' />
                        </td>
                        <td>
                                        ...
                                        <tr>
                                            <td class="span4" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                    <tr>
                                                        <td style="border-style: none; text-align: left; width: 40%;">
                                                            <asp:Label runat="server" ID="Label2" CssClass="red">Country Code</asp:Label>
                                                        </td>
                                                        <td style="border-style: none; text-align: left; width: 60%;">
                                                            <asp:TextBox runat="server" ID="txtcountrycode" MaxLength="3" onkeypress="return CharacterOnly(event);"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                            <td class="span4" style="text-align: left">
                                                <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                    <tr>
                                                        <td style="border-style: none; text-align: left; width: 40%;">
                                                            <asp:Label runat="server" ID="Label1" CssClass="red">Country Name</asp:Label>
                                                        </td>
                                                        <td style="border-style: none; text-align: left; width: 60%;">
                                                            <asp:TextBox runat="server" ID="txtcountryname" MaxLength="50" onkeypress="return CharacterOnlyspace(event);"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
