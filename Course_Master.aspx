<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true"
    CodeFile="Course_Master.aspx.cs" Inherits="Course_Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContainer" runat="Server">
    ...
    <div id="breadcrumbs" class="position-relative" style="height: 53px">
        <ul class="breadcrumb" style="height: 15px">
            ...
            <li>
                <h4 class="blue">Course Master Upload<span class="divider"></span></h4>
            </li>
        </ul>
        <div id="nav-search">
            <!-- /btn-group -->
                                                ...
                                                <tr>
                                                        ...
                                                        <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                            <tr>
                                                                <td style="border-style: none; text-align: left; width: 40%;">
                                                                    <asp:Label ID="lbldivision" runat="server" CssClass="red">Division</asp:Label>
                                                                </td>
                                                    ...
                                                    <td class="span4" style="text-align: left">
                                                        <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                            <tr>
                                                                <td style="border-style: none; text-align: left; width: 40%;">
                                                                    <asp:Label ID="lblcategory" runat="server" CssClass="red">Category </asp:Label>
                                                                </td>
                                                                <td style="border-style: none; text-align: left; width: 60%;">
                                                                    <asp:DropDownList runat="server" ID="ddlCCName" Width="215px" data-placeholder="Select Course Category"
                                                                        CssClass="chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlCCName_SelectedIndexChanged" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                    <td class="span4" style="text-align: left">
                                                        <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                                            <tr>
                                                                <td style="border-style: none; text-align: left; width: 40%;">
                                                                    <asp:Label ID="lblboard" runat="server" CssClass="red">Board </asp:Label>
                                                                </td>
                                                                <td style="border-style: none; text-align: left; width: 60%;">
                                                                    <asp:DropDownList runat="server" ID="ddlBoardName" Width="215px" data-placeholder="Select Board Name"
                                                                        CssClass="chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlBoardName_SelectedIndexChanged" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                                        ...
                                                        <table cellpadding="0" class="table-hover" style="border-style: none;" width="100%">
                                                            <tr>
                                                                <td class="span2" style="border-style: none; text-align: left; width: 40%;">
                                                                    <asp:Label ID="lblmedium" runat="server" CssClass="red">Medium </asp:Label>
                                                                </td>
                                                                <td class="span4" style="border-style: none; text-align: left; width: 60%;">
                                                                    <asp:DropDownList runat="server" ID="ddlMediumName" Width="215px" data-placeholder="Select Medium Name"
                                                                        CssClass="chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlMediumName_SelectedIndexChanged" />
                                                                </td>
                                                            </tr>
                                                        </table>
                                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="span4" style="text-align: left">
                                        <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                            <tr>
                                                <td style="border-style: none; text-align: left; width: 40%;">
                                                    <asp:Label runat="server" ID="Label3">Category</asp:Label>
                                                </td>
                                                <td style="border-style: none; text-align: left; width: 60%;">
                                                    <asp:Label runat="server" ID="lblcategoryresult" class="blue"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td class="span4" style="text-align: left">
                                        <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                            <tr>
                                                <td style="border-style: none; text-align: left; width: 40%;">
                                                    <asp:Label runat="server" ID="Label1">Board</asp:Label>
                                                </td>
                                                <td style="border-style: none; text-align: left; width: 60%;">
                                                    <asp:Label runat="server" ID="lblboardresult" class="blue"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td class="span4" style="text-align: left">
                                        <table cellpadding="0" style="border-style: none;" class="table-hover" width="100%">
                                            <tr>
                                                <td style="border-style: none; text-align: left; width: 40%;">
                                                    <asp:Label runat="server" ID="Label4">Medium</asp:Label>
                                                </td>
                                                <td style="border-style: none; text-align: left; width: 60%;">
                                                    <asp:Label runat="server" ID="lblmediumresult" class="blue"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                    ...
                                    <td class="span4" style="text-align: left"></td>
                                        ...
                                        <asp:DataList ID="datalist_NewUploads1" CssClass="table table-striped table-bordered table-hover"
                                            ...
                                            <HeaderTemplate>
                                                <b>Course Display Name</b>
                                                </th>
                                                <th runat="server" visible="false" style=" text-align: center;">Course
                                                </th>
                                                
                                                <th  runat="server" visible="true" style="width: 14%; text-align: center;">Subject Display Name
                                                </th>
